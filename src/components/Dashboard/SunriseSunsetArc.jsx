...
export default function SunriseSunsetArc({ current, cardBg, borderColor, textColor, subTextColor, isMobile }) {
    ...
    return (
        <div style={{ background: cardBg, borderRadius: '20px', padding: '15px', border: `1px solid ${borderColor}`, gridColumn: 'span 2', display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
            ...
            <div style={{ position: 'relative', width: '100%', maxWidth: '220px', display: 'flex', justifyContent: 'center' }}>
            ...
            <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', padding: '0 15px', marginTop: '-5px' }}>
