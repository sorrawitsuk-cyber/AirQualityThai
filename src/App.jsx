  ...
  const handleMapRadarScan = async () => {
    ...
    try {
      ...
      if (data.alertLevel === 3) {
          ...
          resultCard = { title: "ท้องฟ้าโปร่ง ไม่มีฝน", icon: "☀️", color: "blue", tag: "ปลอดภัย", desc: `เรดาร์ไม่พบกลุ่มฝนบริเวณ ${realLocName} ในขณะนี้ สามารถทำกิจกรรมได้ตามปกติ` };
      }
